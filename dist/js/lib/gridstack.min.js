...
(function(factory) {
  ...
  GridStackEngine.prototype._prepareNode = function(node, resizing) {
    ...
    node.template = node.template || false;
    node.template_id = parseInt('' + node.template_id);
    node.content = parseInt('' + node.content);
    node.style = node.style || false;
    node.aid = parseInt('' + node.aid);
    node.num = parseInt('' + node.num);
    node.modulname = node.modulname || false;
  ...
  GridStackEngine.prototype.addNode = function(node, triggerAddEvent) {
    ...
    if (node.autoPosition) {
      ...
      for (var i = 0;; ++i) {
        ...
        if (!this.nodes.find(Utils._isAddNodeIntercepted, {
            x: x,
            y: y,
            node: node
          })) {
  ...
  GridStack.prototype._prepareElement = function(el, triggerAddEvent) {
    ...
    var node = self.grid.addNode({
      ...
      template: el.attr('data-gs-template'),
      template_id: el.attr('data-gs-template_id'),
      content: el.attr('data-gs-content'),
      style: el.attr('data-gs-style'),
      aid: el.attr('data-gs-aid'),
      num: el.attr('data-gs-num'),
      modulname: el.attr('data-gs-modulname'),
      el: el,
  ...
  // el, x, y, width, height, auto_position, template,template_id,content
  GridStack.prototype.addWidget = function(el, template, template_id, content, style, aid, num, modulname, x, y, width, height, autoPosition, minWidth, maxWidth,
    minHeight, maxHeight, id) {
    el = $(el);
    if (typeof template != 'undefined') {
      el.attr('data-gs-template', template)
    };
    if (typeof template_id != 'undefined') {
      el.attr('data-gs-template_id', template_id)
    };
    if (typeof content != 'undefined') {
      el.attr('data-gs-content', content)
    };
    if (typeof style != 'undefined') {
      el.attr('data-gs-style', style)
    };
    if (typeof aid != 'undefined') {
      el.attr('data-gs-aid', aid)
    };
    if (typeof num != 'undefined') {
      el.attr('data-gs-num', num)
    };
    if (typeof modulname != 'undefined') {
      el.attr('data-gs-modulname', modulname)
    };
