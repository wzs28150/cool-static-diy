/*
 * by 张鑫旭 http://www.zhangxinxu.com/
...
(function($) {
  $.pageRuler = function(params) {
    ...
    $('<div id="zxxScaleRulerH"class="zxxScaleRuler_h"></div><div id="zxxScaleRulerV"class="zxxScaleRuler_v"></div><div id="zxxRefDotH"class="zxxRefDot_h"></div><div id="zxxRefDotV"class="zxxRefDot_v"></div>').appendTo($("body"));
    if (flag) {
      $('<div id="zxxScaleRulerH"class="zxxScaleRuler_h"></div><div id="zxxScaleRulerV"class="zxxScaleRuler_v"></div><div id="zxxRefDotH"class="zxxRefDot_h"></div><div id="zxxRefDotV"class="zxxRefDot_v"></div>').appendTo($("body"));
    } else {
      $("#zxxScaleBox").show();
    ...
    //参考线的水平拖移
    $("body").on("mousedown", ".zxxRefLine_v", function() {
      oDrag = $(this);
      dragFlag = true;
      f.dashv();
    });
    //参考线的垂直拖移
    $("body").on("mousedown", ".zxxRefLine_h", function() {
      oDrag = $(this);
      dragFlag = true;
      f.dashh();
    });
