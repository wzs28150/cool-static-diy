...
(function(factory) {
      ...
      _.each(this.nodes, function(n, i) {
        ...
        while (new_y >= n._orig_y) {
          var collision_node = _.chain(this.nodes)
            .find(function(bn) {
              return n != bn && Utils.is_intercepted({
                x: n.x,
                y: new_y,
                width: n.width,
                height: n.height
  ...
  GridStack.prototype.add_widget = function(el, x, y, width, height, auto_position, template,template_id,catid) {
    el = $(el);
    ...
    if (typeof template != 'undefined') el.attr('data-gs-template', template);
    if (typeof template_id != 'undefined') el.attr('data-gs-template_id', template_id);
    if (typeof catid != 'undefined') el.attr('data-gs-catid', catid);
