...
(function(factory) {
  ...
  GridStackEngine.prototype._prepareNode = function(node, resizing) {
    ...
    node.catid = parseInt('' + node.catid);
  ...
  // el, x, y, width, height, auto_position, template,template_id,catid
  GridStack.prototype.addWidget = function(el, template, template_id, catid,aid,num, modulname, x, y, width, height, autoPosition, minWidth, maxWidth,
